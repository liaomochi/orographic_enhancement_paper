% This script is designed to check if an event is in the list of quality
% events, if the IRC is already done.
...
% for AI test only
tmp = load(['/shared/dondo/home/ml423/world_mts_runs/AI_test_basin_event.mat'],'basin_event_test');
basin_event = tmp.basin_event_test;

if ismember([bid,eid],basin_event,'rows')
    eq = 1;
else
    eq = 0;
end
